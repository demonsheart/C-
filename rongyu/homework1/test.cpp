...
int main()
{
    fstream file;
    /*输入流文件位置*/
    file.open("E:\\C\\.vscode\\rongyu\\homework1\\logs-1160.txt", ios_base::in);
    fstream _out;
    ...
    while (file)
    {
        ...
        smatch m;
        fstream _out;
        string file_name("E:\\C\\.vscode\\rongyu\\homework1\\file2\\"); //输出流根目录
    ...
    fstream resl;
    //在特定位置创建result.txt
    resl.open("E:\\C\\.vscode\\rongyu\\homework1\\file2\\result.txt", ios_base::out);
